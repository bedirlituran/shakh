const Footer = () => {
 return (
   <div className="p-4 pt-16 !text-black sm:max-w-full md:max-w-full">
     <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
       <div className="sm:col-span-2">
        ...
        <h4 className="text-black text-lg font-bold">Şah telecom </h4>
         </a>
         <div className="mt-6 lg:max-w-sm">
           <p className="text-sm text-black">
           Şah telecom, yüksək keyfiyyətli internet TV və təhlükəsizlik sistemləri ilə evinizə və iş yerinizə rahatlıq və təhlükəsizlik gətirir.
           </p>
       ...
       <div className="space-y-2 text-sm">
         ...
         <div className="flex">
           <p className="mr-1 text-black">Mobil:</p>
           <a
         ...
         <div className="flex">
           ...
           <a
             href="mailto:Şah telecom.mmc@gmail.com"
             aria-label="Our email"
             title="Our email"
             className="transition-colors duration-300 text-black hover:text-deep-purple-800"
           >
             Şah telecom.mmc@gmail.com
           </a>
         </div>
         <div className="flex">
           <p className="mr-1 text-black">Adres:</p>
           <a
             ...
             className="transition-colors duration-300 text-black hover:text-deep-purple-800"
           >
             Nizami metro stansiyası yaxınlığında
           </a>
         </div>
       </div>
       <div>
     ...
     <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
       <p className="text-sm text-black">
       © Şah telecom 2024. Bütün hüquqlar qorunur.
       </p>
